...
# Convert these temperatures into the Fahrenheit scale. You can use function celsius_to_fahrenheit()
# defined below that converts a single observation from Celsius to Fahrenheit.
